...
function (_Component) {
  ...
  _createClass(App, [{
    key: "makeSuggestion",
    value: function makeSuggestion(event) {
      event.preventDefault();
      var item = this.refs.description.value; // remove counter when wire up to db -->

      var counter = this.state.counter; //console.log(this.refs);
    ...
    key: "getSuggestion",
    value: function getSuggestion(event) {
      event.preventDefault();
    }
  }]);
  ...
  function App() {
    ...
    _this.makeSuggestion = _this.makeSuggestion.bind(_assertThisInitialized(_assertThisInitialized(_this))); // can use ^App^ or ^this^ here
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        className: "App"
      }, _react.default.createElement("h1", null, this.state.title), _react.default.createElement("form", {
        ref: "suggestionForm"
      }, _react.default.createElement("div", null, _react.default.createElement("input", {
        type: "text",
        ref: "description",
        placeholder: "what's good, b?"
      }), _react.default.createElement("button", {
        onClick: this.makeSuggestion
      }, " Make Suggestion "))), _react.default.createElement("ol", null, suggestions.map(function (sug) {
...
//         </pre>
//           <div>
//             <input type="text" ref="description" placeholder="inspire me!" />
//             <button onClick ={this.getSuggestion}> Get Suggestion </button>
//           </div>
//         </form>
//       </div>
//     );
